...
CDSP_RESAMP_TPL class cdsp_rational_interpolator : public cdsp_block<SPLS_T, SPLS_T> {
public:
...
CDSP_RESAMP_TPL class cdsp_rational_decimator : public cdsp_block<SPLS_T, SPLS_T> {
public:
