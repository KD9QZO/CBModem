#ifndef CDSP_COMMON_H_
#define CDSP_COMMON_H_
...
template<typename T_OUT> class cdsp_block_base {
public:
...
template<typename T_IN, typename T_OUT> class cdsp_block: public cdsp_block_base<T_OUT> {
public:
	virtual ~cdsp_block() {};
